...
class ClusterManagerClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('container');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            subnetworkPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/regions/{region}/subnetworks/{subnetwork}'),
        };
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.container.v1beta1.ClusterManager', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.clusterManagerStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.container.v1beta1.ClusterManager') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.container.v1beta1.ClusterManager, this._opts, this._providedCustomServicePath);
    ...
    listLocations(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.listLocations(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listLocations response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    fetchClusterUpgradeInfo(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    fetchNodePoolUpgradeInfo(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    completeControlPlaneUpgrade(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
