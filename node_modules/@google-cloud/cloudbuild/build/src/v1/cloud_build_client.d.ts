...
export declare class CloudBuildClient {
     ...
     */
    getDefaultServiceAccount(request?: protos.google.devtools.cloudbuild.v1.IGetDefaultServiceAccountRequest, options?: CallOptions): Promise<[
    ...
    getDefaultServiceAccount(request: protos.google.devtools.cloudbuild.v1.IGetDefaultServiceAccountRequest, options: CallOptions, callback: Callback<protos.google.devtools.cloudbuild.v1.IDefaultServiceAccount, protos.google.devtools.cloudbuild.v1.IGetDefaultServiceAccountRequest | null | undefined, {} | null | undefined>): void;
    getDefaultServiceAccount(request: protos.google.devtools.cloudbuild.v1.IGetDefaultServiceAccountRequest, callback: Callback<protos.google.devtools.cloudbuild.v1.IDefaultServiceAccount, protos.google.devtools.cloudbuild.v1.IGetDefaultServiceAccountRequest | null | undefined, {} | null | undefined>): void;
    /**
    ...
    */
     ...
     * @returns {string} Resource name string.
     */
    defaultServiceAccountPath(project: string, location: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromDefaultServiceAccountName(defaultServiceAccountName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromDefaultServiceAccountName(defaultServiceAccountName: string): string | number;
    /**
     ...
     * @returns {string} Resource name string.
     */
    projectBuildsPath(project: string, build: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectBuildsName(projectBuildsName: string): string | number;
    /**
     ...
     */
    matchBuildFromProjectBuildsName(projectBuildsName: string): string | number;
    /**
     ...
     * @returns {string} Resource name string.
     */
    projectLocationBuildsPath(project: string, location: string, build: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationBuildsName(projectLocationBuildsName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationBuildsName(projectLocationBuildsName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the build.
     */
    matchBuildFromProjectLocationBuildsName(projectLocationBuildsName: string): string | number;
    /**
     ...
     * @returns {string} Resource name string.
     */
    projectLocationTriggersPath(project: string, location: string, trigger: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationTriggersName(projectLocationTriggersName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationTriggersName(projectLocationTriggersName: string): string | number;
    /**
     ...
     */
    matchTriggerFromProjectLocationTriggersName(projectLocationTriggersName: string): string | number;
    /**
     ...
     * @returns {string} Resource name string.
     */
    projectTriggersPath(project: string, trigger: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectTriggersName(projectTriggersName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the trigger.
     */
    matchTriggerFromProjectTriggersName(projectTriggersName: string): string | number;
    /**
