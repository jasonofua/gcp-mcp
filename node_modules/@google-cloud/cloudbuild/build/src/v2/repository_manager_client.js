...
exports.RepositoryManagerClient = void 0;
 ...
 */
const gapicConfig = require("./repository_manager_client_config.json");
...
class RepositoryManagerClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            servicePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/namespaces/{namespace}/services/{service}'),
        };
        ...
        this.descriptors.page = {
            ...
            fetchLinkableRepositories: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'repositories')
        };
        ...
        const createConnectionResponse = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.Connection');
        const createConnectionMetadata = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.OperationMetadata');
        const updateConnectionResponse = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.Connection');
        const updateConnectionMetadata = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.OperationMetadata');
        const deleteConnectionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteConnectionMetadata = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.OperationMetadata');
        const createRepositoryResponse = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.Repository');
        const createRepositoryMetadata = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.OperationMetadata');
        const batchCreateRepositoriesResponse = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.BatchCreateRepositoriesResponse');
        const batchCreateRepositoriesMetadata = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.OperationMetadata');
        const deleteRepositoryResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteRepositoryMetadata = protoFilesRoot.lookup('.google.devtools.cloudbuild.v2.OperationMetadata');
        this.descriptors.longrunning = {
            createConnection: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createConnectionResponse.decode.bind(createConnectionResponse), createConnectionMetadata.decode.bind(createConnectionMetadata)),
            updateConnection: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateConnectionResponse.decode.bind(updateConnectionResponse), updateConnectionMetadata.decode.bind(updateConnectionMetadata)),
            deleteConnection: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteConnectionResponse.decode.bind(deleteConnectionResponse), deleteConnectionMetadata.decode.bind(deleteConnectionMetadata)),
            ...
            batchCreateRepositories: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchCreateRepositoriesResponse.decode.bind(batchCreateRepositoriesResponse), batchCreateRepositoriesMetadata.decode.bind(batchCreateRepositoriesMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.devtools.cloudbuild.v2.RepositoryManager', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.repositoryManagerStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.devtools.cloudbuild.v2.RepositoryManager') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.devtools.cloudbuild.v2.RepositoryManager, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const repositoryManagerStubMethods = ['createConnection', 'getConnection', 'listConnections', 'updateConnection', 'deleteConnection', 'createRepository', 'batchCreateRepositories', 'getRepository', 'listRepositories', 'deleteRepository', 'fetchReadWriteToken', 'fetchReadToken', 'fetchLinkableRepositories', 'fetchGitRefs'];
        for (const methodName of repositoryManagerStubMethods) {
            const callPromise = this.repositoryManagerStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    fetchReadWriteToken(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    fetchReadToken(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    fetchGitRefs(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateConnectionProgress(name) {
     ...
     */
    async checkUpdateConnectionProgress(name) {
     ...
     */
    async checkDeleteConnectionProgress(name) {
    ...
    batchCreateRepositories(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkBatchCreateRepositoriesProgress(name) {
    ...
    fetchLinkableRepositories(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    fetchLinkableRepositoriesStream(request, options) {
        ...
        return this.descriptors.page.fetchLinkableRepositories.createStream(this.innerApiCalls.fetchLinkableRepositories, request, callSettings);
    }
    /**
    ...
    fetchLinkableRepositoriesAsync(request, options) {
        ...
        return this.descriptors.page.fetchLinkableRepositories.asyncIterate(this.innerApiCalls['fetchLinkableRepositories'], request, callSettings);
    }
    /**
...
exports.RepositoryManagerClient = RepositoryManagerClient;
//# sourceMappingURL=repository_manager_client.js.map