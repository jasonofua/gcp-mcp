...
class HealthService {
    ...
    computeHealthScore(metrics) {
        ...
        if (metrics.latencyP95 > 500)
            score -= (metrics.latencyP95 - 500) / 20;
        // Deduct for Pod health issues
        if (metrics.podHealth < 100)
            score -= (100 - metrics.podHealth) * 2;
